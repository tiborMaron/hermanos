...
public class DBInitializer {
    ...
    private void initializeProducts() {
        ...
        Product product5 = new Product("Mexican God", "2 slice fried chicken breast, hot cheese, jalapenos with a secret souce", 9.99, "product5.jpg", ProductCategory.BURGER);
        ...
        Product product8 = new Product("2 times HOT", "15 VERY hot chicken drumsticks, 3 curly fried potatoes, 4 hot souce", 16.50, "product8.jpg", ProductCategory.CHICKEN_CART);
        daoProduct.addNewProduct(product8);

        Product product9 = new Product("The Team", "10 fried chicken breast with 10 VERY hot chicken drumsticks, 3 rice, 3 fried potatoes, 5 choosen souce", 25.00, "product9.jpg", ProductCategory.CHICKEN_CART);
        daoProduct.addNewProduct(product9);

        // DRINK

        Product product10 = new Product("Mexican limonade", "Home made limonade with a bit of hot sauce", 2.99, "product10.jpg", ProductCategory.DRINK);
